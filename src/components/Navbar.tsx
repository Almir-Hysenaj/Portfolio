const Navbar = () => {
  ...
  return (
    <nav className="fixed top-7 left-1/2 -translate-x-1/2 px-16 rounded-full overflow-hidden border-teal-800 border-[0.5px] bg-gray-950/50 backdrop-blur-sm shadow-md z-50 w-[90vw] sm:w-auto">
